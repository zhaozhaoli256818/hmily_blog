...
<div class="wrap" style="position: relative;top:40px">
    ...
    <div class="card shadow mb-3" style="width: 20rem; position: fixed;left: 1190px;top:100px;background-color: #b9a3ad ">
        <div class="card-header">
            <div style="float: left;margin-left: 60px;cursor: pointer" onclick="changeDiv(0)">文章分类</div>
            <div style="float: left;margin-left: 20px;cursor: pointer" onclick="changeDiv(1)">作者信息</div>
        </div>
        <div align="center" id="attribute_label">

        </div>
        <div id="author" class="card " style="width: 20rem;height:22rem;display: none;background-color: #b9a3ad ">
    ...
    <div style="position: absolute;left: 360px;top:35px">
        分类:<span id="label">${attribute_label}</span>
    </div>
            ...
            <div class="cntl-states">
                ...
                <div class="cntl-state">
                    <div class="cntl-content shadow">
                        ...
                        <span   id="attribute_label0" style='cursor: pointer' onclick='findArchiveByattributeLabel(this)'>标签</span>
                ...
                <div class="cntl-state">
                    <div class="cntl-content shadow">
                        ...
                        <img style="margin-left:10px " src="${pageContext.request.contextPath}/static/images/icons/tag-fill.svg">
                        <span   id="attribute_label1" style='cursor: pointer' onclick='findArchiveByattributeLabel(this)'>标签</span>
                        <img style="margin-left:10px " src="${pageContext.request.contextPath}/static/images/icons/eye.svg">
                        <span>58</span>
                    </div>
                ...
                <div class="cntl-state">
                    <div class="cntl-content shadow">
                        ...
                        <img style="margin-left:10px " src="${pageContext.request.contextPath}/static/images/icons/tag-fill.svg">
                        <span   id="attribute_label2" style='cursor: pointer' onclick='findArchiveByattributeLabel(this)'>标签</span>
                        <img style="margin-left:10px " src="${pageContext.request.contextPath}/static/images/icons/eye.svg">
                        <span>58</span>
                    </div>
                ...
                <div class="cntl-state">
                    <div class="cntl-content shadow">
                        ...
                        <img style="margin-left:10px " src="${pageContext.request.contextPath}/static/images/icons/tag-fill.svg">
                        <span   id="attribute_label3" style='cursor: pointer' onclick='findArchiveByattributeLabel(this)'>标签</span>
                        <img style="margin-left:10px " src="${pageContext.request.contextPath}/static/images/icons/eye.svg">
                        <span>58</span>
                    </div>
                ...
                <div class="cntl-state">
                    <div class="cntl-content shadow">
                        ...
                        <%--                            <span style="margin-left: 50px" id="type0">文章类别</span>--%>
                        <img style="margin-left:10px " src="${pageContext.request.contextPath}/static/images/icons/tag-fill.svg">
                        <span   id="attribute_label4" style='cursor: pointer' onclick='findArchiveByattributeLabel(this)'>标签</span>
                        <img style="margin-left:10px " src="${pageContext.request.contextPath}/static/images/icons/eye.svg">
                        <span>58</span>
                    </div>
...
<script type="text/javascript">
    ...
    $(function () {
        $.ajax({
            type: "POST",
            url: "${pageContext.request.contextPath}/tag/${attribute_label}",
    ...
    $(function () {
        loadArticelType('001','attribute_label')
    })
        ...
        $.ajax({
            ...
            success: function (data) {
                $.each(data,function (i,obj) {
                    var $div = $("<div class='card-header'><span style='cursor: pointer' onclick='findArchiveByattributeLabel(this)'>"+obj['item_name']+"</span></div>")
                    $("#"+position).append($div);
    ...
    function changePage(val) {
        ...
        var url = "${pageContext.request.contextPath}/tag/"+$("#label").html()+"?page=" + val
    ...
    function findArchiveByattributeLabel(val) {
        $("#label").html($(val).html())
        $.ajax({
            type: "POST",
            url: "${pageContext.request.contextPath}/tag/"+$(val).html(),
    ...
    function changeDiv(val) {
        if (val == 0) {
            $("#attribute_label").css("display", "block");
            $("#author").css("display", "none");
        } else {
            $("#attribute_label").css("display", "none");
